import{L as u,M as y,D as B,E as $}from"./builtins-gpH2uheF.js";function E(f,e){const s=new g(f),i=B();if(i){const n=$();n?n.statements.push(s):i.statements.push(s),i.dependencies.push(f),u(s),s.beginBody(),e(),s.endBody(),y()}return{else(n){i&&(u(s),s.beginElseBody(),n(),s.endElseBody(),y())}}}class g{constructor(e){this.statements=[],this.elseStatements=[],this.isBodyActive=!1,this.isElseBodyActive=!1,this.condition=e}beginBody(){this.isBodyActive=!0}endBody(){this.isBodyActive=!1}beginElseBody(){this.isElseBodyActive=!0}endElseBody(){this.isElseBodyActive=!1}addStatement(e){this.isBodyActive?this.statements.push(e):this.isElseBodyActive&&this.elseStatements.push(e)}toGLSL(){const e=this.condition.toGLSL(),s=[];for(const n of this.statements){const a=n.toGLSL().split(`
