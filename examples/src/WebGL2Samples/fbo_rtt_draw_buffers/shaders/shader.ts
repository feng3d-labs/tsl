import { attribute, builtin, color, fragment, fragmentOutput, mix, precision, return_, sampler2D, texture, uniform, varying, varyingStruct, vec2, vec4, vertex } from '@feng3d/tsl';
