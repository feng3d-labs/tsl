// WGSL Compute Shader for Transform Feedback simulation (SEPARATE_ATTRIBS mode)
// This shader transforms vertices and outputs position and color to separate buffers
