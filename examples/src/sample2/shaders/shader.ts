import { let_, multiply, return_, attribute, fragment, mat4, uniform, vec2, vec4, vertex } from '@feng3d/tsl';
...
export const vertexShader = vertex("main", () =>
{
    ...
    return_(multiply(multiply(uProjectionMatrix, uModelViewMatrix), position));
});
